...
const BackendComponentTable = ({ components, onDelete }) => {
  return (
          ...
          {components.map((component, index) => (
            <tr key={index} className="hover:bg-gray-100 text-center">
              ...
              <td className="py-2 px-4 border-b text-center">
                ...
                >
                  <Link to={`/dashboard/update-backendComponent/${component._id}`}>Update</Link>
                </button>
                <button
...
export default BackendComponentTable;
